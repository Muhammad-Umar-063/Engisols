/**
 * Case studies — REAL. Not demo data.
 *
 * Ported verbatim from the previous site. Every metric here is either a
 * verified figure from the client's own dashboard/site, or a product fact.
 * Nothing in this file is invented, and nothing in it should be replaced with
 * placeholder content.
 *
 * Two notes carried over from the original build:
 *  - SoloSuit's $2.99B / 393K are the PLATFORM's lifetime figures, not
 *    Engisols' outcomes. The wording keeps that attribution — do not tighten it.
 *  - Quick Sync, Alula and PastPresent have no hard performance numbers, so
 *    their metrics are verifiable product facts instead.
 */

export type Metric = { value: string; label: string }
export type SolutionBlock = { heading: string; body: string }
...
export type CaseStudy = {
  ...
  tagline: string
  imgSrc: string
  /** Light-background screenshot — needs a heavier scrim behind overlaid text. */
  imgTone?: 'light'
  /** Carried from the old site's lucide map. Unused by the new design so far. */
  iconName?: string
  metrics: Metric[]
  overview: string
  challenges: string[]
...
[
  {
    ...
    "title": "SoloSuit",
    "category": "Legal Tech",
    "shortDescription": "Legal AI that helps people answer debt lawsuits on their own — guided response flows, generated court documents, attorney review, and settlement tooling.",
    "tagline": "Most people sued over debt never respond, and lose by default. This platform turns a court deadline into a guided flow anyone can complete.",
    "imgSrc": "/work/solosuit.png",
    "imgTone": "light",
    "iconName": "Scale",
    "metrics": [
      {
        "value": "$2.99B",
        "label": "Debt Protected on Platform"
      },
      {
        "value": "393K",
        "label": "People Helped"
    ...
    "solution": [
      {
        ...
        "body": "A Rails backend carrying case state, document generation, and the attorney review pipeline, with React front ends for the guided response flow. The step-by-step structure exists to break an intimidating legal document into questions a person can actually answer one at a time."
      },
      {
        "heading": "Legal AI — ChatGPT API Integration",
        "body": "AI assistance built on the ChatGPT API for legal and financial questions, integrated so it supports users inside the flow rather than sitting off to the side as a chatbot. Retrieval keeps responses anchored to real procedural information instead of generated guesses."
      },
      {
        "heading": "Agentic Workflows",
        "body": "Agent-driven workflows moving a case through its stages — intake, response compilation, document generation, attorney handoff, and filing — so the user experiences one continuous flow rather than a series of disconnected forms."
      },
      {
        "heading": "Document Generation",
        "body": "Court-ready documents assembled from user answers against the requirements of the relevant jurisdiction, then routed for attorney review before filing so a human signs off on what reaches the court."
      },
      {
        "heading": "Settlement Tooling",
        "body": "A parallel path for users who would rather settle than litigate, supporting negotiated payoffs below face value with the fee structure calculated against the settled amount."
      }
    ],
    "results": [
  ...
  },
  {
    ...
    "title": "PastPresent",
    "category": "Agentic AI",
    "shortDescription": "An agentic AI pipeline that turns crowdsourced memories and photos into a printed tribute book — grounded by RAG, moderated before print, invisible by design.",
    "tagline": "Turning scattered memories from dozens of contributors into one printed keepsake — where the automation has to stay invisible for the book to feel handmade.",
    "imgSrc": "/work/pastpresent.jpeg",
    "imgTone": "light",
    "iconName": "BookOpen",
    "metrics": [
      {
        "value": "5",
        "label": "Occasion Types Supported"
      },
      {
        "value": "RAG",
        "label": "Grounded in Real Memories"
      },
      {
        "value": "Zero",
        "label": "Apps for Contributors"
      },
      {
        "value": "Pre-Print",
    ...
    "solution": [
      {
        ...
        "body": "Retrieval-augmented generation scoped to the individual honouree, so every generated line is anchored to details contributors actually submitted. The model works from a real corpus of that person's life rather than generating plausible filler — the difference between a book that moves a family and one that quietly gets things wrong."
      },
      {
        "heading": "Agentic Pipeline",
        "body": "An agent pipeline carries a submission from raw contribution to print-ready page: interpreting what was sent, levelling the prose, placing it in the book, and handing off to layout. Each stage is a distinct step rather than one monolithic prompt, so quality problems can be isolated and fixed."
      },
      {
        "heading": "Voice-Preserving Editing",
        "body": "The editing pass raises the floor without flattening the ceiling. Grammar, structure, and pacing get levelled so a two-line note sits comfortably beside a long reminiscence, while the phrasing and character of each contributor survive the edit."
      },
      {
        "heading": "Photo Curation",
        "body": "Automatic photo arrangement across the book, curating by theme and time period so images land near the stories they belong to instead of being dropped in submission order."
      },
      {
        "heading": "Moderation Before Print",
        "body": "A moderation stage screens submissions before anything reaches print. Because the artefact is physical and often commemorative, this runs as a hard gate rather than a post-hoc flag."
      },
      {
        "heading": "Infrastructure — AWS Amplify",
        "body": "The platform runs on AWS Amplify, covering the contributor-facing submission flow, the organiser dashboard, and the pipeline behind them."
      }
    ],
    "results": [
  ...
  },
  {
    ...
    "shortDescription": "An AI songwriting SaaS rebuilt for growth — Rails product, usage-aware CRM, and an autonomous SEO agent running a daily content operation with no headcount.",
    "tagline": "A songwriting platform with no organic acquisition and a CRM blind to product usage — rebuilt into a self-running growth engine.",
    "imgSrc": "/work/prolyrics.jpeg",
    "iconName": "Brain",
    "metrics": [
      {
        "value": "412K",
    ...
    "solution": [
      {
        ...
        "body": "The core application: a rhyme engine covering perfect, near, and slant rhymes plus mouth-shape matches; an idea generator for lyric starters and emotional angles; genre and idiom libraries; and an open-ended AI assistant for exploring themes and connections."
      },
      {
        "heading": "Performance — Caching Over Large Datasets",
        "body": "The reference libraries are far too large to query naively on every keystroke. A caching layer over the hot paths keeps lookups responsive, so the tools stay usable at the speed someone actually writes."
      },
      {
        "heading": "Monetization — Subscription Tiering",
        "body": "Tiered subscriptions gating feature access across Starter, Pro, and Enterprise plans, with entitlement checks threaded through the tools rather than bolted on at the edges."
      },
      {
        "heading": "CRM — Behaviour-Triggered Lifecycle",
        "body": "Signup, trial, upgrade, and churn events synced from the product into GoHighLevel, turning the CRM from a static contact list into something that reacts to real usage. Nurture sequences now fire on what a user did, not how long ago they registered."
      },
      {
        "heading": "Growth — Autonomous n8n SEO Agent",
        "body": "An autonomous agent handling the full content loop end to end: daily keyword research, brief generation, drafting, schema markup, internal link mapping, and publishing. It targets classic search alongside answer-engine, generative-engine, and AI optimization, so content is retrievable by both crawlers and AI assistants."
      }
    ],
    "results": [
  ...
  },
  {
    ...
    "shortDescription": "A privacy-first decentralized collaboration platform — encrypted file sharing, anonymous live Q&A, and a developer framework for building privacy dApps.",
    "tagline": "Building a privacy-first collaboration platform where sessions are ephemeral, encryption is the default, and no account is ever required.",
    "imgSrc": "/work/quicksync.jpeg",
    "iconName": "ShieldCheck",
    "metrics": [
      {
        "value": "3",
        "label": "dApps in the Suite"
      },
      {
        "value": "Zero",
    ...
    "solution": [
      {
        ...
        "body": "Responsive, animation-led interfaces built in TypeScript, covering the platform surface and both flagship dApps. The design language leans on motion to make invisible cryptographic state legible — session lifecycles, key establishment, and expiry are surfaced as interface feedback rather than technical detail the user has to interpret."
      },
      {
        "heading": "API Layer — Secure Server Routes",
        "body": "Secure API routes handling the operations that cannot run client-side, deliberately scoped so encrypted payloads pass through without the server holding keys or readable content. External service integrations sit behind this layer rather than being called directly from the client."
      },
      {
        "heading": "Data — Prisma-Backed Persistence",
        "body": "Database operations through Prisma for the metadata the platform legitimately needs — channel lifecycles, marketplace listings, and dApp records — kept strictly separate from user content, which never lands in a readable form."
      },
      {
        "heading": "dApps — QS Share and StageX",
        "body": "QS Share delivers ephemeral, end-to-end encrypted file sharing across invitation-only, link-based, and public access modes. StageX brings real-time anonymous Q&A to live sessions and X Spaces, with community voting and moderation tooling that works without identifying participants."
      },
      {
        "heading": "Monetization — Marketplace + Token",
        "body": "Interface work for the QS Marketplace, where developers list privacy dApps, and the $QS token integration underpinning creator monetization and on-chain revenue sharing."
      }
    ],
    "results": [
  ...
  },
  {
    ...
    "shortDescription": "A family caregiving command centre — shared CareSpaces, task boards, encrypted document vaults, and health record integration for distributed care teams.",
    "tagline": "A caregiving coordination platform where scattered family care teams share one source of truth — tasks, calendars, health records, and encrypted documents.",
    "imgSrc": "/work/alula.jpeg",
    "iconName": "HeartPulse",
    "metrics": [
      {
        "value": "7",
        "label": "Care Modules Shipped"
      },
      {
        "value": "AES-256",
      ...
      {
        "value": "6",
        "label": "Secure Vault Categories"
      },
      {
        "value": "MyChart",
        "label": "Health Records Integration"
      }
    ],
    ...
    "solution": [
      {
        ...
        "body": "Figma designs translated into a responsive React application with Redux managing cross-module state — the care recipient context, team membership, and permissions that every screen depends on. Tailwind CSS kept the design system consistent across the marketing site and the dashboards."
      },
      {
        "heading": "Care Modules",
        "body": "Seven modules on a shared shell: a Bulletin Board activity feed with attachments and reactions, a Tasks Board with ownership and priority states, a calendar with recurrence and attendee management, encrypted Document Storage, a Health Zone, MyChart integration for clinical records, and Team Management."
      },
      {
        "heading": "Back End — Node.js + Express + MongoDB",
        "body": "REST APIs in Node.js and Express with MongoDB behind them, modelling CareSpaces, care recipients, team membership, and the permission graph connecting them. Document metadata stays separate from document contents."
      },
      {
        "heading": "Security — JWT + Role-Based Access",
        "body": "JWT authentication with role-based access control distinguishing care recipients from team members and administrators. Documents are held under AES-256 encryption with per-folder permissions, so financial and legal records stay restricted even inside a trusted care team."
      },
      {
        "heading": "Onboarding & Delivery",
        "body": "A progressive onboarding checklist walks a new user from account creation to a populated CareSpace with invited caregivers. Deployed on AWS, with work across performance, security, and accessibility."
      }
    ],
    "results": [
